  ...
  const meetingColumns = [
    ...
    },
    {
      ...
      render: (meeting: MeetingType) => {
        if (meeting.status) {
          if (moment().isBetween(meeting.meetingDate,moment(meeting.meetingDate).add(10, 'minutes'))){
            //if (meeting.meetingDate === (moment().format("LLL"))){
            return (
            ...
            moment(meeting.meetingDate).isBefore(moment().format("LLL"))
          ) {
